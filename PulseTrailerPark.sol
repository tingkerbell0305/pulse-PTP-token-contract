...
contract PulseTrailerPark is ERC20, Ownable {
    ...
    address payable public partnershipWallet;
    ...
    function changeMarketingWallet(address payable _newMarketingWallet) external {
        require(msg.sender == marketingWallet, "Only marketer could change this address");
        marketingWallet = _newMarketingWallet;
    }

    function changeDevWallet(address payable _newDevWallet) external {
        require(msg.sender == devWallet, "Only developer could change this address");
        devWallet = _newDevWallet;
    }

    function changePartnerWallet(address payable _newPartnerWallet) external {
        require(msg.sender == partnershipWallet, "Only developer could change this address");
